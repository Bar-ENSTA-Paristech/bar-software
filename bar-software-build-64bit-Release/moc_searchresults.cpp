...
#include "../bar-software/view/searchresults.h"
...
struct qt_meta_stringdata_SearchResults_t {
    QByteArrayData data[1];
    char stringdata[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_SearchResults_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_SearchResults_t qt_meta_stringdata_SearchResults = {
    {
...
const QMetaObject SearchResults::staticMetaObject = {
    { &MultiList::staticMetaObject, qt_meta_stringdata_SearchResults.data,
      qt_meta_data_SearchResults,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SearchResults.stringdata))
        return static_cast<void*>(const_cast< SearchResults*>(this));
    return MultiList::qt_metacast(_clname);
}

int SearchResults::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = MultiList::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
