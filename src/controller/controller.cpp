...
//        get<0>(view_tmpCustomerInfo).fromStdString( get<1>(db_tmpCurstomerInfo) ) ;
//        get<1>(view_tmpCustomerInfo).fromStdString( get<2>(db_tmpCurstomerInfo) );
//        get<2>(view_tmpCustomerInfo).fromStdString( get<3>(db_tmpCurstomerInfo) );
//        get<3>(view_tmpCustomerInfo) = get<4>(db_tmpCurstomerInfo);
